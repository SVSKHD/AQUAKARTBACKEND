...
router.post("/category-add",userAuth.isLoggedIn,userAuth.checkAdmin,CategoryOperations.addCategory);
router.put(
  "/category-update",
  userAuth.isLoggedIn,
  userAuth.checkAdmin,
...
router.get("/category/delete/:id", userAuth.isLoggedIn, userAuth.checkAdmin, CategoryOperations.deleteCategory)
